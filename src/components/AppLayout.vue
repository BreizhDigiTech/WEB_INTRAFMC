      ...
      <div class="drawer-content flex flex-col">
        ...
        <div class="navbar bg-gray-900/80 backdrop-blur-xl border-b border-gray-700/50 px-6 py-3 sticky top-0 z-50">
          ...
          <div class="flex-none lg:hidden">
            <label for="drawer-toggle" class="btn btn-ghost btn-circle text-white hover:bg-gray-700/50 transition-all duration-200">
          ...
          <div class="flex-1">
            <div class="flex items-center space-x-4">
              <div class="w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg transform hover:scale-105 transition-transform duration-200">
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-green-500/20 border border-green-500/30 rounded-full">
            ...
            <div class="dropdown dropdown-end">
              <div tabindex="0" role="button" class="btn btn-ghost btn-circle text-gray-300 hover:text-white hover:bg-gray-700/50 transition-all duration-200 relative">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M15 17h5l-5 5v-5zM10 3A7 7 0 003 10c0 5.25 3.94 7.5 7 8.27A7.002 7.002 0 0017 10a7 7 0 00-7-7z" />
              ...
              <div tabindex="0" class="dropdown-content z-[1] menu p-0 shadow-2xl bg-gray-900 border border-gray-700 rounded-2xl w-64 mt-3">
            ...
            <!-- Profil utilisateur -->
            <div class="dropdown dropdown-end">
              <div tabindex="0" role="button" class="btn btn-ghost p-2 hover:bg-gray-700/50 transition-all duration-200 rounded-xl">
                <div class="flex items-center gap-3">
                  <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center shadow-lg ring-2 ring-blue-500/20">
              ...
              <div tabindex="0" class="dropdown-content z-[1] menu p-0 shadow-2xl bg-gray-900 border border-gray-700 rounded-2xl w-64 mt-3">
                ...
                <ul class="p-2">
                  <li>
                    <a class="flex items-center gap-3 p-3 text-gray-300 hover:text-white hover:bg-gray-800/50 rounded-xl cursor-pointer transition-all duration-200">
                  ...
                  <li>
                    <a @click="authStore.logout" class="flex items-center gap-3 p-3 text-red-400 hover:text-red-300 hover:bg-red-500/10 rounded-xl cursor-pointer transition-all duration-200">
                      <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <nav class="p-4">
            <ul class="space-y-3">
              ...
              <li>
                ...
                >
                  <div class="w-8 h-8 rounded-lg bg-gray-800 flex items-center justify-center group-hover:bg-blue-500/20 transition-colors duration-200"
                  ...
                  <svg class="w-4 h-4 opacity-0 group-hover:opacity-100 transition-opacity duration-200" 
                       :class="{ 'opacity-100': $route.path.startsWith('/dashboard') }"
              ...
              <li>
                ...
                >
                  <div class="w-8 h-8 rounded-lg bg-gray-800 flex items-center justify-center group-hover:bg-green-500/20 transition-colors duration-200"
                  ...
                  <svg class="w-4 h-4 opacity-0 group-hover:opacity-100 transition-opacity duration-200" 
                       :class="{ 'opacity-100': $route.path.startsWith('/orders') }"
                       fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                  </svg>
                </router-link>
